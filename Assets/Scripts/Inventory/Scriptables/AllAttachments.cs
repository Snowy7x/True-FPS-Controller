...
{
    public int id;
    [EnumFlags] public WeaponType weaponTypes;
    [EnumFlags] public WeaponSubType weaponSubTypes;
...
namespace Inventory
{
    ...
    {
        [InfoBox("The first item in any list of a type is considered the default attachment for that type")]
        [Header("Attachments")]
