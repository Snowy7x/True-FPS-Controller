...
namespace FPS
{
    ...
    public class FPSAnimator : MonoBehaviour
    {
        ...
        [SerializeField, Required("Required field")]
        private AnimatorController defaultHandsController;

        [SerializeField, Required("Required field")]
        private AnimatorController defaultBodyController;
        ...
        public void SetBodyController(AnimatorController newController)
        {
            SetController(bodyAnimator, newController, defaultBodyController);
        }

        public void SetHandsController(AnimatorController newController)
        {
            SetController(handsAnimator, newController, defaultHandsController);
        }

        private void SetController(Animator anim, AnimatorController newController,
            AnimatorController defaultController = null)
        {
